...
export const bellIcon = (w: any = '100%', h: any = '100%') => {
    const xml = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.02 2.91003C8.70997 2.91003 6.01997 5.60003 6.01997 8.91003V11.8C6.01997 12.41 5.75997 13.34 5.44997 13.86L4.29997 15.77C3.58997 16.95 4.07997 18.26 5.37997 18.7C9.68997 20.14 14.34 20.14 18.65 18.7C19.86 18.3 20.39 16.87 19.73 15.77L18.58 13.86C18.28 13.34 18.02 12.41 18.02 11.8V8.91003C18.02 5.61003 15.32 2.91003 12.02 2.91003Z" stroke="#98A2B3" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
    ...
    <path d="M15.02 19.0601C15.02 20.7101 13.67 22.0601 12.02 22.0601C11.2 22.0601 10.44 21.7201 9.90002 21.1801C9.36002 20.6401 9.02002 19.8801 9.02002 19.0601" stroke="#98A2B3" stroke-width="1.5" stroke-miterlimit="10"/>
    </svg>
    `
    return (
        <SvgXml xml={xml} width={w} height={h} />
...
export const option = (w: any = '100%', h: any = '100%', color?: any) => {
    const xml = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3 7H21" stroke="#98A2B3" stroke-width="1.5" stroke-linecap="round" />
    <path d="M3 12H21" stroke="#98A2B3" stroke-width="1.5" stroke-linecap="round" />
    <path d="M3 17H21" stroke="#98A2B3" stroke-width="1.5" stroke-linecap="round" />
</svg>
`
    return (
        <SvgXml xml={xml} width={w} height={h} />
...
export const onboarding = (w: any = '100%', h: any = '100%', color?: any) => {
    const xml = `
<svg width="207" height="179" viewBox="0 0 207 179" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M128.399 45.5556C129.473 41.5482 135.159 41.5482 136.233 45.5556C143.497 72.6601 164.736 93.828 191.854 101.041C195.877 102.111 195.877 107.827 191.854 108.897C164.736 116.11 143.497 137.278 136.233 164.383C135.159 168.39 129.473 168.39 128.399 164.383C121.136 137.278 99.8962 116.11 72.7782 108.897C68.7556 107.827 68.7556 102.111 72.7782 101.041C99.8962 93.828 121.136 72.6601 128.399 45.5556Z" fill="#C1DDFC" style="fill:#C1DDFC;fill:color(display-p3 0.7569 0.8667 0.9882);fill-opacity:1;"/>
<path d="M145.186 11.8874C145.336 10.4226 147.472 10.4226 147.623 11.8874C148.125 16.7897 152.008 20.6703 156.911 21.1606C158.376 21.3071 158.376 23.4429 156.911 23.5894C152.008 24.0797 148.125 27.9603 147.623 32.8626C147.472 34.3274 145.336 34.3274 145.186 32.8626C144.684 27.9603 140.801 24.0797 135.898 23.5894C134.432 23.4429 134.432 21.3071 135.898 21.1606C140.801 20.6703 144.684 16.7897 145.186 11.8874Z" fill="#C1DDFC" style="fill:#C1DDFC;fill:color(display-p3 0.7569 0.8667 0.9882);fill-opacity:1;"/>
<path d="M13.0709 44.1877C13.1628 43.2981 14.4607 43.2981 14.5526 44.1877C14.8598 47.1623 17.2182 49.5187 20.1941 49.8139C21.0841 49.9022 21.0841 51.1997 20.1941 51.288C17.2182 51.5832 14.8598 53.9396 14.5526 56.9143C14.4607 57.8038 13.1628 57.8038 13.0709 56.9143C12.7636 53.9396 10.4052 51.5832 7.42935 51.288C6.53931 51.1997 6.53931 49.9022 7.42935 49.8139C10.4052 49.5187 12.7636 47.1623 13.0709 44.1877Z" fill="#C1DDFC" style="fill:#C1DDFC;fill:color(display-p3 0.7569 0.8667 0.9882);fill-opacity:1;"/>
</svg>
`
    return (
        <SvgXml xml={xml} width={w} height={h} />
